...
import { SsypcBeneficiario } from './ssypc-beneficiario.entity';

@Entity('beneficio_ssypc') // Nombre de la tabla en la base de datos
export class SsypcBeneficio {
  ...
  @ManyToOne(() => SsypcBeneficiario, beneficiario => beneficiario.beneficios)
  @JoinColumn({ name: 'id_beneficiario_ssypc' })
  beneficiario: SsypcBeneficiario;
}