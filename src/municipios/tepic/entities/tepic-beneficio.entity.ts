...
import { TepicBeneficiario } from './tepic-beneficiario.entity';

@Entity('beneficio_tepic') // Nombre de la tabla en la base de datos
export class TepicBeneficio {
  ...
  @ManyToOne(() => TepicBeneficiario, beneficiario => beneficiario.beneficios)
  @JoinColumn({ name: 'id_beneficiario_tepic' })
  beneficiario: TepicBeneficiario;
}