...
@Entity('beneficio_sanpedro') // Nombre de la tabla en la base de datos
export class SanPedroLagunillasBeneficio {
    ...
    @ManyToOne(() => SanPedroLagunillasBeneficiario, beneficiario => beneficiario.beneficios)
