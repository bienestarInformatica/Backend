...
import { RuizBeneficiario } from './ruiz-beneficiario.entity';

@Entity('beneficio_ruiz') // Nombre de la tabla en la base de datos
export class RuizBeneficio {
    ...
    @ManyToOne(() => RuizBeneficiario, beneficiario => beneficiario.beneficios)
    @JoinColumn({ name: 'id_beneficiario_ruiz' })
    beneficiario: RuizBeneficiario;
}