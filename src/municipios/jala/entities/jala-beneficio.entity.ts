...
import { JalaBeneficiario } from './jala-beneficiario.entity';

@Entity('beneficio_jala') // Nombre de la tabla en la base de datos
export class JalaBeneficio {
    ...
    @ManyToOne(() => JalaBeneficiario, beneficiario => beneficiario.beneficios)
    @JoinColumn({ name: 'id_beneficiario_jala' })
    beneficiario: JalaBeneficiario;
}