...
export class AmatlanBeneficiario {
    ...
    @OneToMany(() => AmatlanBeneficio, beneficio => beneficio.beneficiario)
    beneficios: AmatlanBeneficio[];

    @OneToMany(() => AmatlanDomicilioBeneficiario, domicilio => domicilio.beneficiario)
    domicilios: AmatlanDomicilioBeneficiario[];
}
