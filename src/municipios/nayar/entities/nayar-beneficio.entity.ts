...
import { NayarBeneficiario } from './nayar-beneficiario.entity';

@Entity('beneficio_nayar') // Nombre de la tabla en la base de datos
export class NayarBeneficio {
    ...
    @ManyToOne(() => NayarBeneficiario, beneficiario => beneficiario.beneficios)
    @JoinColumn({ name: 'id_beneficiario_nayar' })
    beneficiario: NayarBeneficiario;
}